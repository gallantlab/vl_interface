...
logger = logging.getLogger("VL.permutations.spatial_perms_f13")
...
params = dict(name='f13', dist_from_line=10, ap_params=[25.,5.], m=1)
...
for line_num in line_nums:
    ...
    logger.info("Finished permutations for: {} {}".format(hem, line_num))
